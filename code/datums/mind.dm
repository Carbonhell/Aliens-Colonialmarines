...
/datum/mind/proc/make_Alien(caste = "larva", turf/spawnpoint)
	...
	if(!(caste in possible_castes))
		return
	var/textedpath = "/mob/living/carbon/alien/humanoid/[caste]"
	if(caste == "larva")
	...
	if(current)
		...
		T = pick(xeno_spawn)
	var/mob/living/carbon/alien/A = new path(T)
	transfer_to(A,1)
	if(oldbody)
		qdel(oldbody)
...
/mob/living/carbon/alien/humanoid/big/crusher/mind_initialize()
	..()
	mind.special_role = "Crusher"

/mob/living/carbon/alien/humanoid/big/ravager/mind_initialize()
	..()
	mind.special_role = "Ravager"

/mob/living/carbon/alien/humanoid/big/corroder/mind_initialize()
	..()
