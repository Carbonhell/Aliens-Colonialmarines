...
/proc/create_xeno(ckey)
	...
	switch(alien_caste)
		if("Queen")
			new_xeno = new /mob/living/carbon/alien/humanoid/big/queen(spawn_here)
		if("Praetorian")
			new_xeno = new /mob/living/carbon/alien/humanoid/big/praetorian(spawn_here)
		if("Warrior")
			new_xeno = new /mob/living/carbon/alien/humanoid/warrior(spawn_here)
		if("Sentinel")
		...
		if("Boiler")
			new_xeno = new /mob/living/carbon/alien/humanoid/big/corroder(spawn_here)
		if("Crusher")
			new_xeno = new /mob/living/carbon/alien/humanoid/big/crusher(spawn_here)
		if("Ravager")
			new_xeno = new /mob/living/carbon/alien/humanoid/big/ravager(spawn_here)
		if("Larva")
		...
		if(G_found.mind.assigned_role=="Alien")
			if(alert("This character appears to have been an alien. Would you like to respawn them as such?",,"Yes","No")=="Yes")
				...
				switch(G_found.mind.special_role)//If they have a mind, we can determine which caste they were.
					...
					if("Ravager")
						new_xeno = new /mob/living/carbon/alien/humanoid/big/ravager(T)
					if("Crusher")
						new_xeno = new /mob/living/carbon/alien/humanoid/big/crusher(T)
					if("Corroder")
						new_xeno = new /mob/living/carbon/alien/humanoid/big/corroder(T)
...
/client/proc/cmd_admin_create_xeno_report()
	...
	if(!holder)
		src << "Only administrators may use this command."
		return
	var/input = stripped_input(usr, "Please enter anything you want. Anything. Serious.", ,"", MAX_MESSAGE_LEN) as message|null
	if(!input)
		return
