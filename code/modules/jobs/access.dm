...
/var/const/access_away_generic4 = 208
	...
	//Marine related access
/var/const/access_sulaco_commander = 210
/var/const/access_sulaco_executive = 211
/var/const/access_sulaco_brig = 212
/var/const/access_sulaco_armory = 213
/var/const/access_sulaco_CMO = 214
/var/const/access_sulaco_CE = 215
/var/const/access_sulaco_engineering = 216
/var/const/access_sulaco_medbay = 217
/var/const/access_marine_prep = 218
/var/const/access_marine_medprep = 219
/var/const/access_marine_engprep = 220
/var/const/access_marine_leaderprep = 221
/var/const/access_marine_specprep = 222
/var/const/access_sulaco_research = 223
/var/const/access_squad_alpha = 224
/var/const/access_squad_bravo = 225
/var/const/access_squad_charlie = 226
/var/const/access_squad_delta = 227
/var/const/access_sulaco_bridge = 228
...
/proc/get_all_accesses()
	return list(access_security, access_sec_doors, access_brig, access_armory, access_forensics_lockers, access_court,
	            ...
	            access_sulaco_commander, access_sulaco_executive, access_sulaco_brig, access_sulaco_armory, access_sulaco_CMO,
	            access_sulaco_CE, access_sulaco_engineering, access_sulaco_medbay, access_marine_prep, access_marine_medprep,
	            access_marine_engprep, access_marine_leaderprep, access_marine_specprep, access_sulaco_research, access_squad_alpha,
...
/proc/get_access_desc(A)
	switch(A)
		if(access_sulaco_commander)
			return "Commander's Office"
		if(access_sulaco_executive)
			return "Executive's Office"
		if(access_sulaco_brig)
			return "Sulaco Brig"
		if(access_sulaco_armory)
			return "Sulaco Armory"
		...
		if(access_marine_medprep)
			return "Marine Medic Prep"
		if(access_marine_leaderprep)
		...
		if(access_sulaco_bridge)
			return "Bridge"
		if(access_sulaco_chemistry)
			return "Chemistry"
		if(access_sulaco_cargo)
			return "Requisitions"
//end of marine's access
		if(access_cargo)
			return "Cargo Bay"
		if(access_cargo_bot)
