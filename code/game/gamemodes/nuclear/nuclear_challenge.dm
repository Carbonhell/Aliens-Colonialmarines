...
#define CHALLENGE_TIME_LIMIT 4800
#define CHALLENGE_MIN_PLAYERS 50
#define CHALLENGE_SHUTTLE_DELAY 10200 // 17 minutes, 2 minutes are spent in the bobby.
...
/obj/item/device/nuclear_challenge/attack_self(mob/living/user)
	...
	priority_announce(replacetext(war_declaration, "&#39;","'"), title = "Declaration of War by the [N.nukeops_lastname] family", sound = 'sound/machines/Alarm.ogg')
